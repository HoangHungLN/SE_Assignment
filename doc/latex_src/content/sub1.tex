...
\hline
Chia sẻ tài liệu & Tutor có thể tải lên và chia sẻ tài liệu học tập hoặc bài tập cho các buổi học, đồng bộ với HCMUT_LIBRARY. \\
\hline
Truy cập tài liệu & Sinh viên và tutor có thể truy cập vào kho tài liệu đã được chia sẻ để phục vụ cho buổi học, đồng bộ với HCMUT_LIBRARY. \\
\hline
