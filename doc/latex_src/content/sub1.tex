...
Đăng ký, hủy, theo dõi lịch học dễ dàng; chọn tutor phù hợp; phản hồi sau buổi học; xem và tải về tài liệu tham khảo. \\ \hline

\textbf{Tutor} &
Người cung cấp hỗ trợ học tập &
Thiết lập lịch rảnh; mở/hủy các buổi học; xem danh sách người học; quản lý các buổi học; cập nhật danh sách tài liệu; đánh giá tiến độ sinh viên. \\ \hline
