...
\begin{figure}[H]
  ...
  \vspace{0.5em} % khoảng cách giữa hàng trên và hàng dưới

  % Hai ảnh hàng dưới
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{graphics/sub2/UI_mockup/Trangchu/studentHompage.png}
  ...
  \caption{Giao diện trang chủ và đăng nhập: một ảnh ở trên, hai ảnh ở dưới.}
\end{figure}


% ===== Nhóm 1: 2 ảnh =====
\subsubsection{Sinh viên đăng ký nhóm và tutor nhận/từ chối yêu cầu}
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{graphics/sub2/UI_mockup/Group/1tutor_teachingRegister.png}
    \caption{Tutor tiếp nhận nhóm hướng dẫn}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{graphics/sub2/UI_mockup/Group/1SV_DKGroup_Main.png}
    \caption{Sinh viên đăng ký nhóm học}
  \end{subfigure}
  \caption{Các giao diện của chức năng đăng ký nhóm học.}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Các giao diện thông tin của giảng viên.}
\end{figure}
...
\subsubsection{Sinh viên đăng ký buổi học}
