...
\begin{figure}[H]
  ...
  \adjincludegraphics[
    ...
    clip
  ]{graphics/sub3/Deployment_view.png}     % ← thay bằng đường dẫn thực tế của ảnh
...
\multirow{15}{*}{Session}
& - sessionID: string
& Mã định danh buổi học. \\ \cline{2-3}

& - group: Group
& Nhóm học mà buổi học thuộc về. \\ \cline{2-3}

& - tutor: Tutor
& Tutor phụ trách buổi học. \\ \cline{2-3}

& - subject: string
& Môn học hoặc chủ đề của buổi học. \\ \cline{2-3}

& - schedule: date
& Ngày và giờ diễn ra buổi học. \\ \cline{2-3}

& - duration: int
& Thời lượng buổi học. \\ \cline{2-3}

& - format: string
& Hình thức học: \textit{"on site"} hoặc \textit{"off site"}. \\ \cline{2-3}

& - status: string
& Trạng thái buổi học (đang mở đăng ký, đã đóng đăng ký, đã kết thúc...). \\ \cline{2-3}

& - location: string
& Địa điểm diễn ra buổi học. \\ \cline{2-3}

& - materials: List<Material>
& Danh sách tài liệu chia sẻ trong buổi học. \\ \cline{2-3}

& - evaluations: List<Evaluation>
& Danh sách các đánh giá của tutor cho sinh viên. \\ \cline{2-3}

& - feedback: List<Feedback>
& Danh sách phản hồi của sinh viên. \\ \cline{2-3}

& - attendanceList: Map<Student, bool>
& Danh sách điểm danh: mỗi sinh viên kèm theo trạng thái có mặt. \\ \cline{2-3}

& - participants: List<Student>
& Danh sách sinh viên tham gia buổi học. \\ \cline{2-3}

% ===== METHODS =====

& + registerStudent(student: Student): void
& Đăng ký sinh viên vào buổi học. \\ \cline{2-3}

& + cancleRegistration(student: Student): void
& Hủy đăng ký của một sinh viên. \\ \cline{2-3}

& + updateInfo(subject, schedule, location, format, maxParticipant): void
& Cập nhật thông tin buổi học. \\ \cline{2-3}

& + addMaterial(material: Material): void
& Thêm tài liệu mới cho buổi học. \\ \cline{2-3}

& + markAttendance(student: Student, present: bool): void
& Đánh dấu điểm danh cho sinh viên. \\ \cline{2-3}

& + getAttendanceRate(): double
& Tính và trả về tỉ lệ tham dự buổi học. \\ \cline{2-3}

& + summarizeMinutes(): string
& Tổng hợp nội dung buổi học dưới dạng văn bản. \\ \hline
...
& + faculty: string
& Khoa, bộ môn của người dùng. \\ \cline{2-3}
& + major: string
& Chuyên ngành của người dùng. \\ \hline
...
& - studentName: string
& Họ tên của sinh viên. \\ \cline{2-3}
& - academicYear: int
& Năm học của sinh viên (ví dụ: 1, 2, 3, 4). \\ \cline{2-3}
& - email: string
& Địa chỉ email của sinh viên (có thể trùng với email trong User). \\ \cline{2-3}
& - faculty: string
& Khoa mà sinh viên theo học. \\ \cline{2-3}
& - major: string
& Chuyên ngành cụ thể của sinh viên. \\ \hline
...
& - tutorName: string
& Họ tên của tutor. \\ \cline{2-3}
& - age: int
& Tuổi của tutor. \\ \cline{2-3}
& - email: string
& Địa chỉ email của tutor. \\ \cline{2-3}
& - faculty: string
& Khoa mà tutor trực thuộc. \\ \cline{2-3}
& - major: string
...
& - student: Student
& Sinh viên được đánh giá \\ \cline{2-3}
& - tutor: Tutor
& Tutor thực hiện đánh giá \\ \cline{2-3}
& - session: Session
& Buổi học được đánh giá \\ \cline{2-3}
& - progressScore: double
& Điểm tiến độ \\ \cline{2-3}
& - comments: String
& Nhận xét \\ \cline{2-3}
& - evaluationDate: Date
& Ngày đánh giá \\ \cline{2-3}
& + updateScore(progressScore: double, comments: string): void
& Nhận progressScore (double) và comments (string), cập nhật điểm và nhận xét. \\ \cline{2-3}
& + getEvaluation(): void
& Hiển thị đánh giá của tutor cho sinh viên. \\ \hline
...
\multirow{3}{*}{\makecell{Session \\ Controller}}
& + tutorCreateSession(session: Session): bool
& Nhận vào đối tượng session, tạo một buổi học mới (yêu cầu từ Tutor) và trả về bool (True/False). \\ \cline{2-3}
& + tutorUpdateSession(sessionID: string, updates: map): bool
& Nhận vào sessionID và các thông tin cập nhật, cập nhật thông tin buổi học (yêu cầu từ Tutor) và trả về bool (True/False). \\ \cline{2-3}
& + tutorCancelSession(sessionID: string): bool
& Nhận vào sessionID, hủy một buổi học (yêu cầu từ Tutor) và trả về bool (True/False). \\ \cline{2-3}
& + studentJoinSession(sessionID: string, studentID: string): void
& Nhận vào sessionID và studentID. Thêm học viên vào buổi học (yêu cầu từ sinh viên) và trả về bool (True/False). \\ \cline{2-3}
& + studentLeaveSession(sessionID: string, studentID: string): void
& Nhận vào sessionID và studentID. Xoá học viên khỏi buổi học (yêu cầu từ sinh viên) và trả về bool (True/False). \\ \cline{2-3}
& + manageAttendance(sessionID): void
& Nhận vào sessionID, quản lý việc điểm danh cho buổi học. \\ \cline{2-3}
& + searchSession(key: map): List<Session>
& Nhận vào các khoá, tìm kiếm buổi học theo tiêu chí (ví dụ: môn học, ngày) và trả về danh sách session. \\ \cline{2-3}
& + notifySessionCreated(sessionID: string): bool
& Nhận vào sessionID, gửi thông báo khi một buổi học được tạo thành công và trả về bool (True/False). \\ \cline{2-3}
& + notifySessionCancelled(sessionID: string): bool
& Nhận vào sessionID, gửi thông báo khi một buổi học bị hủy và trả về bool (True/False). \\ \cline{2-3}
& + notifySessionUpdated(sessionID: string): bool
& Nhận vào sessionID, gửi thông báo khi thông tin buổi học được cập nhật và trả về bool (True/False). \\ \cline{2-3}
& + remindSession(sessionID: string, time: date, minuteBefore: int): bool
& Nhận vào sessionID, thời gian buổi học, thời gian trước buổi học. Đặt lịch nhắc nhở buổi học trước một khoảng thời gian nhất định và trả về bool (True/False). \\ \cline{2-3}
& + saveNotification(sessionID: string, time: date, status: string): bool
& Nhận vào sessionID, thời gian buổi học, trạng thái buổi học. Lưu thông báo về buổi học . \\ \hline
...
\multirow{3}{*}{\makecell{Material \\Controller}}
& + accessLearningMaterial(materialID: string): bool
& Nhận vào materialID, truy cập tài liệu học tập của buổi học và trả về bool (True/False). \\ \cline{2-3}
& + shareLearningMaterial(material: Material, sessionID: string): bool
& Nhận vào đối tượn material, sessionID. Chia sẻ tài liệu học tập vào một buổi học, và trả về bool (True/False) \\ \cline{2-3}
& + searchMaterial(key: map): List<Material>
& Nhận vào các khoá, tìm kiếm tài liệu học tập theo tiêu chí và trả về danh sách phản hồi. \\ \hline

% ========== EvaluateController ==========
\multicolumn{3}{|c|}{\textbf{EvaluateController}} \\ \hline
\multirow{2}{*}{\makecell{Evaluate \\Controller}}
& + evaluateProgress(evaluation: evaluation, tutorID: string, studentID: string, sessionID: string): bool
& Nhận vào đối tượng evalution, tutorID, studentID, sessionID, tutor đánh giá tiến độ của học viên và trả về bool (True/False). \\ \cline{2-3}
...
\multirow{2}{*}{\makecell{Feedback \\Controller}}
& + submitFeedback(feedback: Feedback, studentID: \newline tutorID: string, sessionID: string): bool
& Nhận vào đối tượng feedback, studentID, tutorID, sessionID, gửi phản hồi về buổi học và trả về bool (True/False). \\ \cline{2-3}
& + searchFeedback(key: map): List<Feedback>
& Nhận vào các khoá, tìm kiếm phản hồi theo tiêu chí và trả danh sách phản hồi. \\ \hline

\multicolumn{3}{|c|}{\textbf{LoginController}} \\ \hline
\multirow{3}{*}{LoginController}
& \#  currUser: User
&  Đối tượng đại diện cho user hiện tại đang dùng hệ thống \\ \cline{2-3}
& + handleSSOCallback(token: string): bool
&  Nhận vào token là tín hiệu trả về khi hệ thống SSO xác thực thành công và gọi synsUserData(userID: string) để thêm User vào DB (nếu chưa có) và cập nhật currUser và trả về kết quả bool.\\ \cline{2-3}
...
& + studentJoinGroup(groupID: string, studentID: string): bool
&  Nhận vào groupID và studentID, thêm student vào group có ID tương ứng, True nếu thành công.\\ \cline{2-3}
...
\multirow{2}{*}{HCMUT\_SSO}
& + getUserID(token: string): userID: string 
&  Nhận vào giá trị token và trả về userID tương ứng của token đó\\ \cline{2-3}
& + authenticateUser(userID: string, password: string): token: string
&  Nhận vào ID và password lấy từ UI và xác thực người dùng, nếu xác thực đúng thì trả về token.\\ \hline

\multicolumn{3}{|c|}{\textbf{HCMUT\_DATACORE}} \\ \hline
\multirow{1}{*}{\makecell{HCMUT\\ \_DATACORE} }
& + getUserProfile(token): User
&  Nhận vào token, một user được khởi tạo bên trong hàm với các thông tin lấy từ datacore và trả về đối tượng user đó.\\ \hline

\multicolumn{3}{|c|}{\textbf{HCMUT\_LIBRARY}} \\ \hline
\multirow{1}{*}{\makecell{HCMUT\\
\_LIBRARY}}
...
\multirow{6}{*}{EvaluateDatabase}
& + storeEvaluation(evaluation: Evaluation): bool
& Nhận giá trị là một đối tượng Evaluation, lưu đánh giá và trả về bool (True/False). \\ \cline{2-3}
& + getStudentProgress(studentID: string): int
& Nhận giá trị studentID, trả về tiến độ của sinh viên (int). \\ \cline{2-3}
& + getEvaluationByTutor(TutorID: string): List<Evaluation>
& Nhận giá trị TutorID, trả về danh sách đánh giá (List<Evaluation>) của Tutor. \\ \cline{2-3}
& + getEvaluationByStudent(StudentID: string): List<Evaluation>
& Nhận giá trị StudentID, trả về danh sách đánh giá (List<Evaluation>) của học sinh. \\ \cline{2-3}
