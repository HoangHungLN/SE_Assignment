...
Hiển thị màn hình "Trang đăng nhập" , thu thập thông tin đăng nhập và chuyển cho tầng nghiệp vụ để gọi dịch vụ SSO.

\noindent\textbf{Home page / Dashboard UI (gói giao diện trang chủ)}  \\
Chịu trách nhiệm hiển thị trang chủ chứa các chức năng tương ứng với từng vai trò của người dùng .
...
"Sinh viên đăng ký nhóm học" ,
"Tutor tiếp nhận nhóm hướng dẫn" ,
và các popup chi tiết như "Thông tin nhóm chi tiết", "Danh sách tutor phù hợp", "Thông tin tutor".
